...
>
  <h3 className="about-section-text text-xl sm:text-2xl lg:text-3xl">
    ...
    <br />
    <p>
      My work experience involves React and Next.js, DevOps tools such as
      Microsoft Azure, and UI/UX design using Figma.
    </p>
    <br />
    <p>
      When I’m not writing code, you’ll probably find me writing music and
